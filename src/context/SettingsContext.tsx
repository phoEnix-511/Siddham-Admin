...
const defaultSettings: SiteSettings = {
  ...
  storeEmail: 'support@siddhamwellness.com',
      ...
      .then(data => {
        if (data.settings) {
          ...
          setSettings({
            ...
            storeEmail: raw.store_email || 'support@siddhamwellness.com',
            storePhone: raw.store_phone || '+91 83198 77420',
            storeInstagram: raw.social_instagram || '',
            storeFacebook: raw.social_facebook || '',
